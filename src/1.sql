...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2017-10-17 00:56:55',NULL),('diagnostics.include_raw','OFF','2017-10-17 00:56:55',NULL),('ps_thread_trx_info.max_length','65535','2017-10-17 00:56:55',NULL),('statement_performance_analyzer.limit','100','2017-10-17 00:56:55',NULL),('statement_performance_analyzer.view',NULL,'2017-10-17 00:56:55',NULL),('statement_truncate_len','64','2017-10-17 00:56:55',NULL);
...
-- Dump completed on 2018-02-05  9:12:20
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
-- Host: localhost    Database: zuoye
-- ------------------------------------------------------
-- Server version	5.7.20-log
...
INSERT INTO `denglu` VALUES (5,'123','ICy5YqxZB1uWSwcVLSNLcA=='),(6,'23','23'),(7,'4','4'),(8,'5','5'),(9,'6','6');
...
INSERT INTO `kaoshi` VALUES (4,'22@qq.com','Qpf0SxOVUjUkWySXOZ16kw==','123',1,'123','2017-11-17',0,'2017-11-30 09:32:11',NULL,0,1);
...
INSERT INTO `room` VALUES (1,'教室'),(2,'超市'),(3,'便利店'),(4,'餐厅');
...
CREATE TABLE `shiti` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `TIMU` varchar(20) NOT NULL,
  `XX` varchar(20) DEFAULT NULL,
  `DAAN` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `shiti` VALUES (1,'我最喜欢吃什么水果','A 苹果  B橘子  C西瓜','c'),(2,'我最喜欢什么轴体的键盘','A 青轴  B 黑轴 C红轴 D茶轴 ','c'),(4,'我最喜欢什么动物 ','A 猫  B狗 C 猫和狗','c');
...
INSERT INTO `student` VALUES (1,'辛贵轩',1),(2,'尹金凯',2),(3,'张光辉',3),(4,'王某某',4),(5,'王某某1',1),(6,'王某某2',1);
...
CREATE TABLE `test` (
  ...
  `TIME1` year(4) DEFAULT NULL,
  `TIEM2` time DEFAULT NULL,
...
INSERT INTO `test` VALUES (1,'xyx','2017-10-20 11:36:11',2017,'11:40:11','2017-10-20',10),(2,'111',NULL,NULL,NULL,NULL,NULL),(3,'222',NULL,NULL,NULL,NULL,NULL),(4,'333',NULL,NULL,NULL,NULL,NULL),(5,'444',NULL,NULL,NULL,NULL,NULL),(6,'555',NULL,NULL,NULL,NULL,NULL),(7,'666',NULL,NULL,NULL,NULL,NULL);
...
--
-- Table structure for table `lianxi3`
--

DROP TABLE IF EXISTS `lianxi3`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `lianxi3`
--

LOCK TABLES `lianxi3` WRITE;
/*!40000 ALTER TABLE `lianxi3` DISABLE KEYS */;
INSERT INTO `lianxi3` VALUES ('2017-10-18 00:00:00');
/*!40000 ALTER TABLE `lianxi3` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `shiti` (
  ...
  `TIMU` varchar(50) NOT NULL,
  `XX` varchar(50) NOT NULL,
  `DAAN` varchar(50) NOT NULL,
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`ID`),
  UNIQUE KEY `TIHAO` (`TIHAO`),
...
LOCK TABLES `shiti` WRITE;
/*!40000 ALTER TABLE `shiti` DISABLE KEYS */;
INSERT INTO `shiti` VALUES (1,'1+1=?','A1  B2  C3  D4','B',1),(2,'2+2=?','A4  B6  C8  D10','A',2),(6,'3+3=?','A3  B6  C9  D12','B',3),(4,'3+6=?','A4  B6  C9  D12','C',4),(5,'3+9=?','A5  B6  C9  D12','D',5);
/*!40000 ALTER TABLE `shiti` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `shiti1`
--

DROP TABLE IF EXISTS `shiti1`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shiti1` (
...
--
-- Dumping data for table `shiti1`
--

LOCK TABLES `shiti1` WRITE;
/*!40000 ALTER TABLE `shiti1` DISABLE KEYS */;
INSERT INTO `shiti1` VALUES (1,NULL,NULL,NULL,1),(2,NULL,NULL,NULL,2),(3,NULL,NULL,NULL,3),(5,NULL,NULL,NULL,4),(NULL,'1',NULL,NULL,5),(NULL,'',NULL,NULL,6),(NULL,'1',NULL,NULL,7);
/*!40000 ALTER TABLE `shiti1` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary view structure for view `shitu`
--

DROP TABLE IF EXISTS `shitu`;
/*!50001 DROP VIEW IF EXISTS `shitu`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `shitu` AS SELECT 
 1 AS `timu`*/;
SET character_set_client = @saved_cs_client;

--
-- Table structure for table `youxi`
--
...
--
-- Dumping data for table `youxi`
--

LOCK TABLES `youxi` WRITE;
/*!40000 ALTER TABLE `youxi` DISABLE KEYS */;
/*!40000 ALTER TABLE `youxi` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `youxi1`
--

DROP TABLE IF EXISTS `youxi1`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `youxi1` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `youxi1`
--

LOCK TABLES `youxi1` WRITE;
/*!40000 ALTER TABLE `youxi1` DISABLE KEYS */;
INSERT INTO `youxi1` VALUES (1,'王子文','2017-10-17 23:00:00','家','睡觉','倍爽'),(2,'王子文','2017-10-17 17:50:11','咖啡馆','喝咖啡','除了肉少点别的还不错'),(3,'王子文','2017-10-17 23:00:00','咖啡馆','喝咖啡','倍爽'),(4,'辛贵轩','2017-10-17 19:57:11','盈园国际商务中心805','练习数据库的增加方法','有点小复杂，外加有点小蒙蔽'),(5,'辛贵轩','2017-10-17 19:57:11','盈园国际商务中心805','练习数据库的增加方法','有点小复杂，外加有点小蒙蔽'),(6,'辛贵轩','2017-10-17 19:57:11','盈园国际商务中心805','练习数据库的增加方法','有点小复杂，外加有点小蒙蔽'),(7,'辛贵轩','2017-10-17 23:00:00','家','睡觉','倍爽');
/*!40000 ALTER TABLE `youxi1` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Final view structure for view `shitu`
--
...
/*!50001 VIEW `shitu` AS select `shiti`.`TIMU` AS `timu` from `shiti` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
CREATE TABLE `classify` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `classify_name` varchar(45) DEFAULT NULL,
  ...
  `iseffect` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `classify` VALUES (1,'键盘','jp',NULL,'x',NULL,NULL,NULL,NULL,NULL,NULL),(2,'鼠标','sb',NULL,'x',NULL,NULL,NULL,NULL,NULL,NULL),(3,'耳机','ej',NULL,'x',NULL,NULL,NULL,NULL,NULL,NULL),(4,'斐尔可','filco',NULL,'jp',NULL,NULL,NULL,NULL,NULL,NULL),(5,'樱桃原厂','cherry',NULL,'jp',NULL,NULL,NULL,NULL,NULL,NULL),(6,'罗技','lg',NULL,'sb',NULL,NULL,NULL,NULL,NULL,NULL),(7,'赛睿','sr',NULL,'sb',NULL,NULL,NULL,NULL,NULL,NULL),(8,'森海塞尔','sh',NULL,'ej',NULL,NULL,NULL,NULL,NULL,NULL),(9,'拜亚动力','by',NULL,'ej',NULL,NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO `dictionaries` VALUES (1,'山东','ssd','nu','s',NULL,NULL,NULL,NULL,NULL,NULL),(2,'青岛','cqd','ssd','ss',NULL,NULL,NULL,NULL,NULL,NULL),(3,'黑龙江','shlj','nu','s',NULL,NULL,NULL,NULL,NULL,NULL),(4,'鸡西','cjx','shlj','ss',NULL,NULL,NULL,NULL,NULL,NULL),(5,'济南','cjn','ssd','ss',NULL,NULL,NULL,NULL,NULL,NULL),(6,'哈尔滨','cheb','shlj','ss',NULL,NULL,NULL,NULL,NULL,NULL),(7,'城阳区','rcy','cqd','sss',NULL,NULL,NULL,NULL,NULL,NULL),(8,'市北','rsb1','cqd','sss',NULL,NULL,NULL,NULL,NULL,NULL),(9,'高新区','rgx','cjn','sss',NULL,NULL,NULL,NULL,NULL,NULL),(10,'天桥区','rtq','cjn','sss',NULL,NULL,NULL,NULL,NULL,NULL),(11,'鸡东区','rjd','cjx','sss',NULL,NULL,NULL,NULL,NULL,NULL),(12,'虎林区','rhl','cjx','sss',NULL,NULL,NULL,NULL,NULL,NULL),(13,'松北区','rsb','cheb','sss',NULL,NULL,NULL,NULL,NULL,NULL),(14,'道里区','rdl','cheb','sss',NULL,NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `information` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `information_name` varchar(45) DEFAULT NULL,
  `code` varchar(45) DEFAULT NULL,
  `univalence` varchar(45) DEFAULT NULL,
  `descr` varchar(45) DEFAULT NULL,
  `inventory` varchar(45) DEFAULT NULL,
  `status` varchar(45) DEFAULT NULL,
  `url` varchar(999) DEFAULT NULL,
  `url2` varchar(45) DEFAULT NULL,
  `url3` varchar(45) DEFAULT NULL,
...
INSERT INTO `information` VALUES (9,'Filco象牙白斐尔可键盘','filco5c0cf045-aa16-4413-98bb-141f3d203278','1599','一流手感 信仰产品','13','1','/xx/image/21f02ebe-58cf-4ef1-9f13-99b94f8baa6d.jpg',NULL,NULL,34,'filco','2017-12-27 11:20:42',NULL,'111',NULL,'2','1'),(10,'樱桃3494原厂键盘','cherry217b45b4-8195-4110-9e87-89f939c7984d','1099','德国原厂 原汁原味','12','1','/xx/image/091a6505-87dd-4c45-826c-cf1e9ece51fa.jpg',NULL,NULL,34,'cherry','2017-12-27 11:39:18',NULL,'111',NULL,'2','1'),(11,'G900罗技鼠标','lga94cf61c-5b39-401a-a51b-1eeb9c2ed224','899','大厂旗舰 真.黑科技','12','1','/xx/image/3aeb8cdf-4866-4517-ac89-1fefe74c2188.jpg',NULL,NULL,34,'lg','2017-12-27 11:44:57',NULL,'111',NULL,'2','1'),(12,'赛睿大师赛睿鼠标','sr4e39611c-e1f6-4d0e-8bc4-0f7b0aa013c5','599','精准灵敏 职业最爱','2','1','/xx/image/39e507cd-561a-4bd7-95b1-f2dd13b9cff3.jpg',NULL,NULL,34,'sr','2017-12-27 11:45:53',NULL,'111',NULL,'2','1'),(13,'谢蓝图拜亚动力耳机','bybf203bb6-62da-4804-ac88-cdd33f98df30','7899','均衡通透  便携易推','12','1','/xx/image/2da19e3c-6382-4329-93eb-4880d8a77fe5.jpg',NULL,NULL,34,'by','2017-12-27 11:47:31',NULL,'111',NULL,'2','1'),(14,'HD800森海塞尔耳机','sh7c28645c-6273-4e21-8922-2510ad61ce19','12999','三频均衡  音乐盛宴','12','1','/xx/image/921f3fd5-4005-45e2-a225-f26631d1ab24.jpg',NULL,NULL,34,'sh','2017-12-27 11:49:23',NULL,'111',NULL,'2','1');
...
CREATE TABLE `order_information` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) DEFAULT NULL,
  `commodity_code` varchar(45) DEFAULT NULL,
...
INSERT INTO `order_information` VALUES (28,32,'filco5c0cf045-aa16-4413-98bb-141f3d203278','6',NULL,54,'075c2e6b-d92e-4377-9d88-7f56424316b4','2018-01-15 16:36:38',NULL,NULL,NULL,NULL,NULL),(29,32,'lga94cf61c-5b39-401a-a51b-1eeb9c2ed224','18',NULL,54,'075c2e6b-d92e-4377-9d88-7f56424316b4','2018-01-15 16:36:38',NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO `order_number` VALUES (21,'075c2e6b-d92e-4377-9d88-7f56424316b4','32','2018-01-15 16:36:38',NULL,NULL,NULL,NULL,NULL,'25776');
...
INSERT INTO `shipping_address` VALUES (54,32,'12','123','shlj','cheb','rdl','213','2017-12-25 11:56:28',NULL,'xinguixuan',NULL,'2','1'),(55,32,'rqwrqw','eqwe','ssd','cjn','rtq','qew','2017-12-25 11:57:07',NULL,'xinguixuan',NULL,'2','1');
...
CREATE TABLE `shopping_trolley` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) DEFAULT NULL,
  `information_code` varchar(45) DEFAULT NULL,
  `quantity` varchar(45) DEFAULT NULL,
  `createtime` varchar(45) DEFAULT NULL,
  `updatetime` varchar(45) DEFAULT NULL,
  `creator` varchar(45) DEFAULT NULL,
  ...
  `isdelete` varchar(45) DEFAULT NULL,
  `iseffect` varchar(45) DEFAULT NULL,
  `total_prices` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`)
...
--
-- Dumping data for table `shopping_trolley`
--

LOCK TABLES `shopping_trolley` WRITE;
/*!40000 ALTER TABLE `shopping_trolley` DISABLE KEYS */;
INSERT INTO `shopping_trolley` VALUES (154,32,'filco5c0cf045-aa16-4413-98bb-141f3d203278','6',NULL,NULL,NULL,NULL,NULL,NULL,'9594'),(155,32,'lga94cf61c-5b39-401a-a51b-1eeb9c2ed224','18',NULL,NULL,NULL,NULL,NULL,NULL,'16182');
/*!40000 ALTER TABLE `shopping_trolley` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `user` VALUES (32,'xinguixuan','ICy5YqxZB1uWSwcVLSNLcA==','123','2','2017-12-17 19:09:41',NULL,'è¾è´µè½©',NULL,'2','1'),(33,'1','xMpCOKC5I4INzFCab3WEmw==','1','2','2017-12-21 17:06:36',NULL,'è¾è´µè½©',NULL,'2','1'),(34,'111','ICy5YqxZB1uWSwcVLSNLcA==','123','1','2017-12-21 17:07:32',NULL,'è¾è´µè½©',NULL,'2','1'),(35,'123','ICy5YqxZB1uWSwcVLSNLcA==','123','2','2017-12-26 20:40:04',NULL,'è¾è´µè½©',NULL,'2','1'),(36,'12345','ICy5YqxZB1uWSwcVLSNLcA==','123','1','2017-12-26 20:42:06',NULL,'è¾è´µè½©',NULL,'2','1'),(37,'123456','ICy5YqxZB1uWSwcVLSNLcA==','12312','1','2017-12-26 20:45:09',NULL,'è¾è´µè½©',NULL,'2','1'),(38,'sdasa','ICy5YqxZB1uWSwcVLSNLcA==','213','1','2017-12-27 09:04:40',NULL,'è¾è´µè½©',NULL,'2','1');
...
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
-- Host: localhost    Database: jichuzhishi
-- ------------------------------------------------------
-- Server version	5.7.20-log
...
--
-- Table structure for table `chuanjian`
--

DROP TABLE IF EXISTS `chuanjian`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `chuanjian` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `NAME` varchar(20) DEFAULT NULL,
  `AGE` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `chuanjian`
--

LOCK TABLES `chuanjian` WRITE;
/*!40000 ALTER TABLE `chuanjian` DISABLE KEYS */;
INSERT INTO `chuanjian` VALUES (1,'XXX',24,'男','2017-10-18 19:52:11',NULL,NULL,NULL,NULL),(2,NULL,NULL,NULL,NULL,2017,NULL,NULL,NULL),(3,NULL,NULL,NULL,NULL,NULL,'2017-10-18',NULL,NULL),(4,NULL,NULL,NULL,NULL,NULL,NULL,'20:10:11',NULL),(5,NULL,NULL,NULL,'2017-10-18 20:10:11',NULL,NULL,NULL,NULL),(6,NULL,NULL,NULL,'2017-10-18 20:10:11',NULL,NULL,NULL,NULL),(7,NULL,NULL,NULL,'2017-10-18 20:10:11',NULL,NULL,NULL,NULL),(8,'辛贵轩',24,'男','2017-10-18 19:52:11',NULL,NULL,NULL,NULL),(9,NULL,NULL,NULL,NULL,2017,NULL,NULL,NULL),(10,NULL,NULL,NULL,NULL,NULL,'2017-10-18',NULL,NULL),(11,NULL,NULL,NULL,NULL,NULL,NULL,'20:10:11',NULL),(12,NULL,NULL,NULL,'2017-10-18 20:10:11',NULL,NULL,NULL,NULL),(13,'222',NULL,NULL,NULL,NULL,NULL,NULL,NULL);
/*!40000 ALTER TABLE `chuanjian` ENABLE KEYS */;
UNLOCK TABLES;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
--
-- Dumping data for table `t_cus_dev_plan`
--

LOCK TABLES `t_cus_dev_plan` WRITE;
/*!40000 ALTER TABLE `t_cus_dev_plan` DISABLE KEYS */;
INSERT INTO `t_cus_dev_plan` VALUES (1,1,'测试计划项','2011-01-01','好'),(4,1,'haha','2015-05-20','en啊'),(5,1,'ss','2015-05-13',''),(6,16,'2121','2015-05-28',''),(7,16,'21121','2015-05-19',''),(8,19,'21','2015-05-28',''),(9,2,'1','2015-05-27','2'),(10,2,'2','2015-05-28',''),(11,21,'好','2015-06-09','额'),(12,22,'联系客户，介绍产品','2015-06-01','有点效果'),(13,22,'请客户吃饭，洽谈','2015-06-07','成功了');
/*!40000 ALTER TABLE `t_cus_dev_plan` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `t_customer_contact`
--

LOCK TABLES `t_customer_contact` WRITE;
/*!40000 ALTER TABLE `t_customer_contact` DISABLE KEYS */;
INSERT INTO `t_customer_contact` VALUES (1,1,'2015-05-14','1','2'),(2,1,'2015-05-06','1','2');
/*!40000 ALTER TABLE `t_customer_contact` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `t_customer_linkman`
--

LOCK TABLES `t_customer_linkman` WRITE;
/*!40000 ALTER TABLE `t_customer_linkman` DISABLE KEYS */;
INSERT INTO `t_customer_linkman` VALUES (1,1,'1','男','321','321','21321'),(2,1,'2','女','21','321','321'),(4,1,'3','女','4','5','6'),(5,1,'33','男','44','55','66'),(6,1,'张三','男','经理','21321','32132121'),(7,1,'是','女','发送','2321','321321');
/*!40000 ALTER TABLE `t_customer_linkman` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `t_customer_loss`
--

LOCK TABLES `t_customer_loss` WRITE;
/*!40000 ALTER TABLE `t_customer_loss` DISABLE KEYS */;
INSERT INTO `t_customer_loss` VALUES (1,'1','大风科技','小张','2015-02-01','2014-05-01',1,'11'),(3,'KH20150526073022','鸟人科技','小红','2014-02-02','2014-05-01',1,'公司迁地址'),(4,'KH20150526073023','321','小丽','2014-02-03',NULL,1,NULL);
/*!40000 ALTER TABLE `t_customer_loss` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `t_customer_order`
--

LOCK TABLES `t_customer_order` WRITE;
/*!40000 ALTER TABLE `t_customer_order` DISABLE KEYS */;
INSERT INTO `t_customer_order` VALUES (1,1,'DD11213','2015-02-01','11',1),(2,16,'DD11212','2014-01-02','22',1),(3,16,'DD21321','2014-02-02','22',1),(4,17,'DD2121','2014-02-03','ss',1);
/*!40000 ALTER TABLE `t_customer_order` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `t_customer_reprieve`
--

LOCK TABLES `t_customer_reprieve` WRITE;
/*!40000 ALTER TABLE `t_customer_reprieve` DISABLE KEYS */;
INSERT INTO `t_customer_reprieve` VALUES (1,1,'打电话给客户，询问不卖我司产品原因2'),(2,1,'发送我司最新产品给客户'),(3,1,'s'),(4,4,'多发'),(5,4,'2121');
/*!40000 ALTER TABLE `t_customer_reprieve` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `t_datadic`
--

LOCK TABLES `t_datadic` WRITE;
/*!40000 ALTER TABLE `t_datadic` DISABLE KEYS */;
INSERT INTO `t_datadic` VALUES (1,'客户等级','普通客户'),(2,'客户等级','重点开发客户'),(3,'客户等级','大客户'),(4,'客户等级','合作伙伴'),(5,'客户等级','战略合作伙伴'),(6,'服务类型','咨询'),(7,'服务类型','建议'),(8,'服务类型','投诉');
/*!40000 ALTER TABLE `t_datadic` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `t_order_details` VALUES (1,1,'联想笔记本',2,'台',4900,9800),(2,1,'惠普音响',4,'台',200,800),(3,2,'罗技键盘',10,'个',90,900),(4,3,'艾利鼠标',20,'个',20,400),(5,3,'东芝U盘',5,'个',105,525),(6,4,'充电器',1,'个',30,30);
...
--
-- Dumping data for table `t_sale_chance`
--

LOCK TABLES `t_sale_chance` WRITE;
/*!40000 ALTER TABLE `t_sale_chance` DISABLE KEYS */;
INSERT INTO `t_sale_chance` VALUES (1,'主动来找的','风软科技',100,'采购笔记本意向','张先生','137234576543','。。。','Jack','2014-01-01 00:00:00','3','2015-05-24 16:15:00',1,2),(2,'','1',12,'','','','','12',NULL,'3','2015-05-25 11:21:00',1,1),(8,NULL,'7',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,0),(9,NULL,'8',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,0),(10,NULL,'9',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,0),(13,'','21',1,'','','','','21',NULL,'3',NULL,0,0),(14,'2','1',5,'6','3','4','7','8',NULL,'3',NULL,0,0),(15,'213','112',22,'','','','','221','2013-01-01 11:20:00','3','2013-01-01 11:20:00',1,0),(16,'22','11',55,'66','33','44','77','88','2013-01-01 11:20:00','4','2013-01-01 11:20:00',1,3),(17,'321','121',1,'321','321','213','321','321','2015-05-22 11:23:00','3',NULL,0,0),(18,'321','321',11,'321','321','213','321','Jack','2015-05-22 11:43:00','',NULL,0,0),(19,'321','213',21,'21','21','321','321','Jack','2015-05-24 11:33:00','3','2015-05-24 11:34:00',1,3),(20,'321','213',100,'321','321','321','321','Jack','2015-05-24 11:35:00','',NULL,0,0),(21,'行业介绍','大鸟爱科技',80,'阿凡达深刻理解','张先生','0231-321321','发达放大空间发大水发大水了发','Jack','2015-06-10 16:32:00','4','2015-06-10 16:33:00',1,3),(22,'同行介绍','鸟人科技',90,'采购IBM服务器意向','张三','2321321321',',...','Jack','2015-06-11 08:35:00','5','2015-06-11 08:36:00',1,2);
/*!40000 ALTER TABLE `t_sale_chance` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2018-02-05  9:12:21
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
-- Host: localhost    Database: order_number
-- ------------------------------------------------------
-- Server version	5.7.20-log
...
INSERT INTO `classroom` VALUES (1,'2018-01-18 16:37:45',NULL,'123@qq.com',NULL,NULL,NULL,'123','fb27f2c5-d20a-4c4f-aa9b-b26aa8e0cc86','dalsdsa@qq.com'),(2,'2018-01-18 19:10:55',NULL,'123@qq.com',NULL,NULL,NULL,'3年2班','d56ad5d4-bcf1-4edc-b1b6-8ca94719c9c6','laoshi@qq.com');
...
LOCK TABLES `dictionaries` WRITE;
/*!40000 ALTER TABLE `dictionaries` DISABLE KEYS */;
INSERT INTO `dictionaries` VALUES (1,NULL,NULL,NULL,NULL,NULL,NULL,'student','学生'),(2,NULL,NULL,NULL,NULL,NULL,NULL,'teacher','讲师'),(3,NULL,NULL,NULL,NULL,NULL,NULL,'administration','教务');
/*!40000 ALTER TABLE `dictionaries` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `permission` VALUES (1,NULL,NULL,NULL,NULL,NULL,NULL,'添加系統',NULL,'add','x'),(2,NULL,NULL,NULL,NULL,NULL,NULL,'添加班級','2_add_class.jsp','addclass','add'),(3,NULL,NULL,NULL,NULL,NULL,NULL,'添加用戶','2_add_user.jsp','adduser','add'),(4,NULL,NULL,NULL,NULL,NULL,NULL,'添加权限','2_add_permission.jsp','addpermission','add'),(5,NULL,NULL,NULL,NULL,NULL,NULL,'查询系统',NULL,'select','x'),(7,NULL,NULL,NULL,NULL,NULL,NULL,'查询班级','4_select_class.jsp','selectclass','select'),(8,NULL,NULL,NULL,NULL,NULL,NULL,'查询讲师','4_select_teacher.jsp','selectteacher','select'),(9,NULL,NULL,NULL,NULL,NULL,NULL,'查询学生','4_select_student.jsp','selectstudent','select');
...
INSERT INTO `role` VALUES (1,NULL,NULL,NULL,NULL,NULL,NULL,'学生','student'),(2,NULL,NULL,NULL,NULL,NULL,NULL,'讲师','teacher'),(3,NULL,NULL,NULL,NULL,NULL,NULL,'教务','administration');
...
INSERT INTO `role_permission_rel` VALUES (1,NULL,NULL,NULL,NULL,NULL,NULL,'administration','add','x'),(2,NULL,NULL,NULL,NULL,NULL,NULL,'administration','addclass','add'),(3,NULL,NULL,NULL,NULL,NULL,NULL,'administration','adduser','add'),(4,NULL,NULL,NULL,NULL,NULL,NULL,'administration','addpermission','add'),(5,NULL,NULL,NULL,NULL,NULL,NULL,'administration','select','x'),(6,NULL,NULL,NULL,NULL,NULL,NULL,'administration','selectclass','select'),(7,NULL,NULL,NULL,NULL,NULL,NULL,'administration','selectteacher','select'),(8,NULL,NULL,NULL,NULL,NULL,NULL,'administration','selectstudent','select');
...
LOCK TABLES `user` WRITE;
/*!40000 ALTER TABLE `user` DISABLE KEYS */;
INSERT INTO `user` VALUES (14,NULL,NULL,NULL,NULL,NULL,NULL,'123@qq.com','123','administration',NULL,'辛'),(17,'2018-01-22 14:03:28',NULL,'123@qq.com',NULL,NULL,NULL,'xuesheng@qq.com','ICy5YqxZB1uWSwcVLSNLcA==','student','d56ad5d4-bcf1-4edc-b1b6-8ca94719c9c6','辛贵轩1'),(18,'2018-01-23 14:45:43',NULL,'123@qq.com',NULL,NULL,NULL,'laoshi@qq.com','ICy5YqxZB1uWSwcVLSNLcA==','teacher','d56ad5d4-bcf1-4edc-b1b6-8ca94719c9c6','杜鲜'),(19,'2018-01-24 15:16:02',NULL,'123@qq.com',NULL,NULL,NULL,'12345@qq.com','ICy5YqxZB1uWSwcVLSNLcA==','student','d56ad5d4-bcf1-4edc-b1b6-8ca94719c9c6','辛贵轩');
/*!40000 ALTER TABLE `user` ENABLE KEYS */;
UNLOCK TABLES;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
